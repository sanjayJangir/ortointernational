				...
				<div class="col">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb white-color">
							...
							<li class="breadcrumb-item active" aria-current="page">Owner-Operator-lmia</li>
						</ol>
					</nav>
				</div>
			</div> <!-- End row -->
	...
	<section id="about-2" class="wide-60 about-section division">
		<div class="container">
			<div class="row d-flex align-items-center">
				<?php
				$about = db_query("select * from  tbl_site_pages where site_pages_id='77'");
		...
		<div class="row d-flex align-items-center">
			...
			<div id="sb-01" class="col-md-8 col-lg-6 sb-box">
				<div class="sbox-6">
					...
					<p style="font-size:24px;" class="p-sm"><span style="font-color:yellow;">01.</span>
						Financial assets to launch or purchase a business in India.</p>
			...
			<div id="sb-02" class="col-md-8 col-lg-6 sb-box">
				<div class="sbox-6">
					...
					<p style="font-size:24px;" class="p-sm"><span style="font-color:yellow;">02.</span>
						Several years of business experience.</p>
			...
			<div id="sb-03" class="col-md-8 col-lg-6 sb-box">
				<div class="sbox-6">
					...
					<!-- Text -->
					<p style="font-size:24px;" class="p-sm"><span style="font-color:yellow;">03.</span>The business must employ at least one Canadian citizen or permanent resident.</p>
			...
			<div id="sb-04" class="col-md-8 col-lg-6 sb-box">
				<div class="sbox-6">
					...
					<!-- Text -->
					<p style="font-size:24px;" class="p-sm"><span style="font-color:yellow;">04.</span> A score of at least 5 on the Canadian Language Benchmark Test (CLB) in speaking, listening, reading, and writing competencies in English or French. </p>
				</div>
			</div>
