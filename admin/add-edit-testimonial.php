...
if ($_REQUEST['delImage'] != "") {
   ...
   $isDel = db_query("UPDATE  tbl_testimonial SET  test_image_name='' WHERE 1 and id = '$categoryID'");
...
if (is_post_back()) {
   ...
   if ($_REQUEST['id'] != '0') {
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
         ...
         $imgToDel = db_scalar("SELECT test_image_name FROM tbl_testimonial WHERE  id='$categoryID'");
      ...
      $sql = "update tbl_testimonial set        
				test_given_by='$_REQUEST[test_given_by]',
				test_comp_name='$_REQUEST[test_comp_name]',
...
$categoryID = $_GET['id'];
if ($categoryID = $_GET['id']) {
   $result = db_query("select * from tbl_testimonial where id = '$categoryID'");
               ...
               <div class="panel-body">
                  <form name="form1" method="post" onsubmit="return formValidation()" enctype="multipart/form-data" class="col-sm-12">
                     ...
                     <div class="form-group col-lg-3">
                        ...
                        <?php if ($test_image_name != "") { ?>
                           <div class="col-lg-12 "><a href="add-edit-testimonial.php?delImage=<?= $test_image_name ?>&id=<?= $categoryID ?>" style="font-weight:600;margin-left:15px;text-decoration:underline">Remove Image</a>
                           </div>
                        <?php } ?>
                     ...
                     <div class="form-group col-lg-3">
                        ...
                        <select name="test_status" class="form-control">
                           <option value="Active" <?php if ($test_status == 'Active') { ?> selected="selected" <?php } ?>>Active</option>
                           <option value="Inactive" <?php if ($test_status == 'Inactive') { ?> selected="selected" <?php } ?>>Inactive</option>
                        </select>
