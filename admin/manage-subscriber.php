...
if (is_post_back()) {
   ...
   if (is_array($arr_ids)) {
      ...
      if (isset($_REQUEST['Delete'])) {
         ...
         db_query("DELETE FROM tbl_subscriber WHERE subscriber_id in ($str_ids)");
         $_SESSION["msg"] = "selected subscriber are deleted. ";
      }
   }
...
$order_by == '' ? $order_by = 'subscriber_id' : true;
...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <span class="count-num">Total : <?= db_scalar("SELECT COUNT(subscriber_id) FROM  tbl_subscriber ") ?></span>
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td class="text-center v-middle">
                                          <a href="mailto:<?= $line_raw["subscriber_email"] ?>"><?= $line_raw["subscriber_email"] ?></a>
                                       </td>


                                       <td class="text-center v-middle">
                                          <?= date("d-M-Y", strtotime($line_raw["subscriber_add_date"])) ?>
                                       </td>

                                       <td class="text-center v-middle"><input name="arr_ids[]" type="checkbox" id="arr_ids[]" value="<?= $subscriber_id ?>" /></td>
