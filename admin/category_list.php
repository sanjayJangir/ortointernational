   ...
   if (is_array($_REQUEST['arr_ids'])) {
      ...
      function del_sub($CAT)
      {
         ...
         while ($SQL = mysqli_fetch_array($select)) {
            ...
            //DELETE SUB brand AND PRODUCTS MORE IMAGES START
            $del_image = db_query("delete from tbl_category_image where category_image_cat_id='$SQL[category_id]'");
            //DELETE SUB brand AND PRODUCTS MORE IMAGES END
         }
         //DELETE ALL brand MORE IMAGES FROM FOLDER START
         ...
         //DELETE ALL brand MORE IMAGES FROM FOLDER END
         //DELETE ALL brand IMAGES FROM FOLDER START
         ...
         //DELETE ALL brand IMAGES FROM FOLDER END
...
if (is_post_back()) {
   ...
   if (isset($_REQUEST['Update'])) {
      ...
      $_SESSION["msg"] = "Selected brand order is set.";
   }
