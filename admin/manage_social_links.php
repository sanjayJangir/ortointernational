...
<div class="inner-addon left-addon">
<i class="fa fa-skype" style="color:#00aff0; font-size:28px"></i>
<input type="text" class="form-control" placeholder="Enter Skype link here" value="<?=$data_new['admin_skype_link']?>" name="admin_skype_link" id="admin_skype_link" />
</div>
...
<div class="inner-addon left-addon">
<i class="fa fa-youtube" style="color:#FF0000; font-size:28px"></i>
...
<input type="text" class="form-control" placeholder="Enter Whatsapp number without country code" value="<?=$data_new['admin_whatsapp_number']?>" name="admin_whatsapp_number" id="admin_whatsapp_number" />
</div>
