...
if (!empty($delImageID)) {
   ...
   header("Location: category_image_list.php?cat_id=$_REQUEST[cat_id]&subcatid=$_REQUEST[subcatid]&catid=$_REQUEST[catid]");
   exit;
}
if (is_post_back()) {
...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         ...
         <a href="product_list.php?subcatid=<?= $_REQUEST['subcatid'] ?>&catid=<?= $_REQUEST['catid'] ?>" class="btn btn-link" style="float: right;font-size: 14px;margin: -20px 18px 0 0; border: solid thin #337ab785;"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i>
            Go Back</a>
         ...
         <span class="count-num">Total : <?= db_scalar("SELECT COUNT(category_image_id) FROM tbl_category_image WHERE category_image_cat_id='$_REQUEST[cat_id]'") ?></span>
                  ...
                  <div class="table-responsive">
                     ...
                     ?>
                           <div class="col-lg-2 text-center" style="margin-bottom:10px">
                              ...
                              <div class="col-lg-12 text-center" style="margin-top:10px"><a href="category_image_list.php?DelID=<?= $DATA['category_image_id'] ?>&cat_id=<?= $_REQUEST['cat_id'] ?>&subcatid=<?= $_REQUEST['subcatid'] ?>&catid=<?= $_REQUEST['catid'] ?>"><i class="fa fa-trash fa-2x" style="color:#F00"></i></a></div>
                           </div>
                     <?php }
                     } ?>
                     <div class="cb"></div>
