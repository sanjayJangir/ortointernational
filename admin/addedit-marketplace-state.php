...
header("location:addedit-marketplace-state.php?id=$categoryID");
}
   ...
   if ($_REQUEST['id'] != '0') {
      ...
      if ($dupliDataCount == '0') {
        ...
        category_status='$_REQUEST[category_status]'
         ...
         $_SESSION["msg"] = "Sorry! State name is already exist";
         $_SESSION["type"] = "error";
      }
      header("Location:addedit-marketplace-state.php?id=$_REQUEST[id]");
      exit;
...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="header-title">
         <h1>Add/Edit marketplace</h1>
         <small>Add/Edit marketplace content</small>


         <a href="marketplace_state_list.php"><button id="btn-go-back" type="button" class="btn btn-labeled btn-inverse m-b-5 pull-right">
