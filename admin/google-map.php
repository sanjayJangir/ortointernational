...
$sql="UPDATE tbl_admin SET admin_contactus_map_link='$_REQUEST[admin_contactus_map_link]' WHERE 1 AND admin_id='$_REQUEST[admin]'";	 
db_query($sql);
$_SESSION['msg']="Google map is updated successfully.";
}


$reg_sql=db_query("select * from tbl_admin where 1 and admin_id='$_REQUEST[admin]'");
...
<textarea name="admin_contactus_map_link" id="admin_contactus_map_link" class="" style="width:100%;height:200px" ><?=$regdata['admin_contactus_map_link']?></textarea>

<span style="color: red;font-weight: bold;">Note: size must ( WIDTH - 600 x HEIGHT - 450 )</span>
...
<?php if($_REQUEST['view']=='yes'){?>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padd center" >
<?=$regdata['admin_contactus_map_link']?>
</div>
<?php }?>
