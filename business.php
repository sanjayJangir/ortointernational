...
<?php 
$about = db_query("select * from  tbl_site_pages where site_pages_id='81'");
					...
					<div class="container">
						...
						<div class="row">	
							<div class="col-md-12 section-title center">		
								...
								<!-- Text -->	
								<p>There are several ways you can immigrate through the business avenues.</p> 
								  	<p>Common requirements amongst the dozens of business programs are:</p> 
						...
						<div class="row d-flex align-items-center">
							...
							<div id="sb-01" class="col-md-8 col-lg-6 sb-box">
								<div class="sbox-6">
									...
									<p style="font-size:24px;"class="p-sm"><span style="font-color:yellow;">01.</span>Previous business or managerial experience.</p>
							...
							<div id="sb-02" class="col-md-8 col-lg-6 sb-box">
								<div class="sbox-6">
									...
									<!-- Text -->
										<p style="font-size:24px;"class="p-sm"><span style="font-color:yellow;">02.</span>Adequate finances to start or purchase your own business. Typically $200,000+CAD is a good starting point.</p>
							...
							<div id="sb-03" class="col-md-8 col-lg-6 sb-box">
								<div class="sbox-6">
									...
									<!-- Text -->
									<p style="font-size:24px;"class="p-sm"><span style="font-color:yellow;">03.</span>Good language profiency in English or French.</p>
							...
							<div id="sb-04" class="col-md-8 col-lg-6 sb-box">
								<div class="sbox-6">
									...
									<!-- Text -->
									<p style="font-size:24px;"class="p-sm"><span style="font-color:yellow;">04.</span>A business plan for a new or exisiting business.</p>
								</div>							
							</div>
