...
<?php 
$page_data = db_query("select * from tbl_site_pages where site_pages_link='workshop'");
...
<div class="container" id="divyancont" style="background-image:url('<?=$site_url?>/static_files/<?=$page[site_pages_inner_banner]?>')"></div>
...
<div class="row">
<?php if(!empty($page['site_pages_image_name'])){?>    
<div class="col-lg-12">
<img src="<?=$site_url?>/static_files/<?=$page['site_pages_image_name']?>" alt="<?=$compDATA['admin_company_name']?>">
</div>
<?php }?>
